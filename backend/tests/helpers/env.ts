...
process.env.FIAT_CURRENCY = process.env.FIAT_CURRENCY ?? 'USD';
process.env.EXCHANGE_RATE_API_URL =
  process.env.EXCHANGE_RATE_API_URL ?? 'https://api.coinbase.com/v2/exchange-rates?currency=BTC';
process.env.EXCHANGE_RATE_CACHE_MS = process.env.EXCHANGE_RATE_CACHE_MS ?? '60000';
process.env.WATCHER_POLL_INTERVAL_MS = process.env.WATCHER_POLL_INTERVAL_MS ?? '30000';
process.env.WATCHER_MIN_CONFIRMATIONS = process.env.WATCHER_MIN_CONFIRMATIONS ?? '1';
